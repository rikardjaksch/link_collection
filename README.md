# Collection of links
Below is a list of different links that I'm mainly keep for personal use.

## Git
* [Git online book](http://git-scm.com/book)
...
* [German articles, but loads of code examples](http://www.spieleprogrammierung.net/p/opengl-tutorial-liste.html)
* [OpenGL Specifications](http://www.opengl.org/registry/)
* [Long good series of modern OpenGL](http://ogldev.atspace.co.uk/)
* [Short but good series on modern OpenGL](http://open.gl/)
* [Revamped lighthouse3D](http://www.lighthouse3d.com/)
* [Mixed collection of articles](http://www.ozone3d.net/tutorials/)
* [WIP series on modern OpenGL](http://antongerdelan.net/opengl4/)
* [OpenGL 3.3 tutorials](http://www.mbsoftworks.sk/index.php?page=tutorials&series=1)
